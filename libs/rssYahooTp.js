...
function generateXML (data){
    ...
    // TODO 這邊把 toGMTString 改成 toString
    ifTruePush(data.pubDate, channel, { 'pubDate': new Date(data.pubDate).toString() });
    ...
    data.items.forEach(function(item) {
        ...
        ifTruePush(item.summary, item_values, { summary: { _cdata: item.summary } });
        ...
        ifTruePush(item.subcategory, item_values, { subcategory: item.subcategory });

        item.categories.forEach(function(category) {
            ifTruePush(category, item_values, { category: { _cdata: category } });
        });

        ifTruePush(item.author || data.author, item_values, { 'author': { _cdata: item.author || data.author } });
